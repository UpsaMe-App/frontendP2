...
class UserRepliesPage extends StatefulWidget {
  ...
  @override
  State<UserRepliesPage> createState() => _UserRepliesPageState();
}
...
class _UserRepliesPageState extends State<UserRepliesPage> {
  ...
  Future<void> _loadUserReplies() async {
    ...
    try {
      final replies = await ApiService.getUserReplies(widget.userId);
      setState(() {
        _replies = replies;
        _isLoading = false;
      });
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            '${widget.userName} no ha respondido a ningún post',
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // ===== RESPUESTA DEL USUARIO (PREMIUM STYLE) =====
                Container(
                  width: double.infinity,
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // Header con "Respuesta de [nombre]"
                      Row(
                        children: [
                          Container(
                      ...
                      // Respuesta del usuario con avatar
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          // Avatar del usuario
