...
class _CreatePostPageState extends State<CreatePostPage> {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Subject selector (only for helper and student)
                    ...
                    if (selectedPostType == PostType.student) ...[
                      GestureDetector(
                        onTap: _pickImage,
                        child: Container(
                    ...
                    if (selectedPostType == PostType.helper) ...
                      Row(
                        children: [
                          Expanded(
                            child: TextFormField(
  ...
  Widget _buildRoleChip({
    ...
    final isSelected = selectedPostType == postType;
